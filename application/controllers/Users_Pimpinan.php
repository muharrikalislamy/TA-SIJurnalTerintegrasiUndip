...
class Users_Pimpinan extends CI_Controller
{
	...
	function edit_user()
	{
		...
		$this->load->view('v_edit_user_pimpinan', $data);
	}
	...
	function edit_username()
	{
		...
		$this->load->view('v_edit_username_pimpinan', $data);
	}
	...
	function edit_password()
	{
		...
		$this->load->view('v_edit_password_pimpinan', $data);
	}
}
