...
class Users_Evaluator extends CI_Controller
{
	...
	function edit_user()
	{
		...
		$this->load->view('v_edit_user_evaluator', $data);
	}
	...
	function edit_username()
	{
		...
		$this->load->view('v_edit_username_evaluator', $data);
	}
	...
	function edit_password()
	{
		...
		$this->load->view('v_edit_password_evaluator', $data);
	}
}
