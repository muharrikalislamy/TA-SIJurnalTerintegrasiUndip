            ...
            <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-header">
                  ...
                  <p>
                    <?php echo $this->session->userdata('nama_user'); ?> - Pengelola
                ...
                <li class="user-body">
                  <div class="row">
                    <div class="col-xs-6 text-center">
                      <a href="/serasi/pengelola-data/edit/<?php echo $this->session->userdata('id_user') ?>">Ubah Profil</a>
                    </div>

                    <div class="col-xs-6 text-center">
                      <a href="/serasi/upload-foto-pengelola">Ubah Foto</a>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-xs-6 text-center">
                      <a href="/serasi/pengelola-data/edit-username/<?php echo $this->session->userdata('id_user') ?>">Ubah Username</a>
                    </div>

                    <div class="col-xs-6 text-center">
                      <a href="/serasi/pengelola-data/edit-password/<?php echo $this->session->userdata('id_user') ?>">Ubah Password</a>
                    </div>
                  </div>
                  <!-- /.row -->
                </li>
