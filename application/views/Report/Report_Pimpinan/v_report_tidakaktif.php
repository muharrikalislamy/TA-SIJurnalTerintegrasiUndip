 ...
 <div class="content-wrapper">
  ...
  <section class="content">
    <div class="box box-success box-solid">
      ...
      <div class="box-body">
        <table id="data-jurnal" class="table table-bordered table-striped scroll" style="background-color:white;">
          ...
          <tbody>
            ...
            foreach ($jurnal as $b) { ?>
              <tr>
                ...
                <td><?php echo $b->terbit_terakhir ?></td>
