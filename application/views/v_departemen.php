...
<div class="content-wrapper">
  ...
  <section class="content">
    <a href="<?= base_url('data-departemen/add'); ?>" class="btn btn-success fa fa-plus-square-o"> Tambah Departemen</a>
    <hr>

    <div class="box box-success box-solid">
      <!-- satu box -->
      <div class="box-header with-border">
        <h3 class="box-title">Tabel Data Departemen</h3>
      </div>
      <div class="box-body">
            ...
            foreach ($departemen as $b) { ?>
              <tr>
                ...
                <?php foreach ($fakultas as $fk) {
                  if ($fk->kode_fakultas ==  $b->kode_fakultas) : ?>
                    <td>
                      <font size="4px">
                        <div class="label label-default"><?php echo $fk->nama ?></div>
                      </font>
                    </td>
                <?php endif;
                } ?>
                ...
                <td>
                  ...
                  <a href="<?php echo base_url(); ?>data-departemen/edit/<?php echo $b->kode_departemen ?>" class="btn btn-primary fa fa-edit"> Edit</a>

                  <a href="<?php echo base_url(); ?>Departemen/delete_departemen/<?php echo $b->kode_departemen ?>" class="btn btn-danger fa fa-trash-o" onClick="return confirmDelete();"> Hapus</a>
