  ...
  <head>
    <div class="bar">
      <section class="content-header">
        <h1>
          Data Fakultas
          <small>Tambah Data Fakultas</small>
        </h1>
        <ol class="breadcrumb">
          <li><a href="/serasi"><i class="fa fa-dashboard"></i> Home</a></li>
          <li><a href="/serasi/data-fakultas"> Fakultas</a></li>
  ...
  <section class="content">
    <div class="box box-success box-solid">
      ...
      <div class="box-header with-border">
        ...
        <h3 class="box-title">Form Tambah Data Fakultas</h3>
      </div>

      <div class="box-body">

        <form action="<?php echo base_url('data-fakultas/add') ?>" method="post">
          <div class="form-group">
            <label for="inputnamafakultas" class="col-sm-2 control-label">Nama fakultas : </label>
            <div class="col-md-9">
              <input class="form-control" name="inputnamafakultas" placeholder="Nama Fakultas" type="text" required />
            </div>
          </div>
      </div> <!-- box body -->
