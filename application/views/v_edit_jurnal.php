...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box box-success box-solid">
      ...
      <div class="box-body">
        <form action="<?php echo base_url('data-jurnal/update-jurnal') ?>" method="post">
          ...
          <div class="col-md-9">
            <select class="form-control " name="pengelola" required id="select-portal">
              ...
              <?php foreach ($pengelola as $key => $kelola) { ?>
                <option value="<?= $kelola->id_user ?>" <?php if ($kelola->id_user ==  $record['id_user']) {
                                                            echo 'selected="selected"';
                                                          } ?>><?= $kelola->nama_user ?> </option>
              <?php } ?>
            </select>
          </div>
        </div>
