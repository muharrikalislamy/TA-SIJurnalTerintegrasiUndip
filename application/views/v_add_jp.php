...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box box-success box-solid">
      ...
      <div class="box-body">
        <form action="<?php echo base_url('data-jp/submit-jp') ?>" method="post">
              ...
              foreach ($jp as $jp) { ?>
                <?php if ($id == $jp->kode_jurnal) : ?>
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo base_url(); ?>JP/delete_jP/<?php echo $jp->kode_jp ?>" class="btn btn-danger fa fa-trash-o" onClick="return confirmDelete();"> Hapus</a>
                    </td>
                  </tr>
              <?php endif;
              } ?>
