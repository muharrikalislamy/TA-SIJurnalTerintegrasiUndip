...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Daftar Fakultas</li>
    </ol>
  </section>


  <section class="content">
    <a href="<?= base_url('data-fakultas/add'); ?>" class="btn btn-success fa fa-plus-square-o"> Tambah Fakultas</a>
    <hr>

    <div class="box box-success box-solid">
      <!-- satu box -->
      <div class="box-header with-border">
        <h3 class="box-title">Tabel Data Fakultas</h3>
      </div>
      <div class="box-body">
        <table id="data-fakultas" class="table table-bordered table-striped scroll" style="background-color:white;">
            ...
            foreach ($fakultas as $b) { ?>
              <tr>
                ...
                <td>
                  ...
                  <a href="<?php echo base_url(); ?>data-fakultas/edit/<?php echo $b->kode_fakultas ?>" class="btn btn-primary fa fa-edit"> Edit</a>

                  <a href="<?php echo base_url(); ?>Fakultas/delete_fakultas/<?php echo $b->kode_fakultas ?>" class="btn btn-danger fa fa-trash-o" onClick="return confirmDelete();"> Hapus</a>
  ...
  <?php if ($this->session->flashdata('duplicateNama')) { ?>
    <div class="modal modal-danger fade in" id="myModal" style="display: block; padding-right: 17px;" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">Maaf Nama Fakultas tersebut sudah terdaftar</h4>
          </div>
          <div class="modal-footer">
            <button type="button" aria-label="Close" class="btn btn-primary" data-dismiss="modal">Close</button>
          </div>
