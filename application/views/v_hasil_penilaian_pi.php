            ...
            <tbody>
              ...
              foreach ($alternatifsort as $key => $a) { ?>
                <tr>
                  ...
                  <td>
                    <font size="4px">
                      <div class="label label-default"> <?php echo $a->kode_alternatif ?>
                  </td>
        ...
        <div class="tab-pane" id="belum">
          <table id="tiapkrit" class="table table-bordered table-striped scroll" style="background-color:white;">
            ...
            <tbody>
              <?php
              $noo = 1;
              foreach ($alternatif as $key => $alte) { ?>
                <!-- foreach alte vertial -->
                <tr>
                  <td><?php echo $noo++ ?></td>
                  <td>
                    <font size="4px">
                      <div class="label label-default"> <?= $alte->singkatan ?>
                  </td> <!-- krit vertikal -->

                  <?php
                    foreach ($kriteria as $key => $value) { ?>
                    <!-- foreach nilai matriks -->
