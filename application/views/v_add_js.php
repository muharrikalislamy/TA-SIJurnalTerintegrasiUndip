...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box box-success box-solid">
      ...
      <div class="box-body">
        <form action="<?php echo base_url('data-js/submit-js') ?>" method="post">
          <div class="form-group">
            <label for="inputnomorsk" class="col-sm-2 control-label">Nomor SK : </label>
            <div class="col-md-9">
              <select class="form-control " name="inputnomorsk" required>
                <option value="0" selected>-- Pilih Nomor SK --</option>
                <?php foreach ($sk as $key => $s) { ?>
                  <option value="<?= $s->kode_sk ?>"><?= $s->nomor ?></option>
                <?php } ?>
              </select>
              <!-- <input class="form-control" name="inputnomorsk" placeholder="Nomor SK" required /> -->
            </div>
          </div>
      </div> <!-- box body -->
              ...
              foreach ($js as $js) { ?>
                <?php if ($id == $js->kode_jurnal) : ?>
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo base_url(); ?>JS/delete_js/<?php echo $js->kode_js ?>" class="btn btn-danger fa fa-trash-o" onClick="return confirmDelete();"> Hapus</a>
                    </td>
                  </tr>
              <?php endif;
              } ?>
