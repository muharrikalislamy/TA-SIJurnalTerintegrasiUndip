...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Daftar Portal</li>
    </ol>
  </section>


  <section class="content">
    <a href="<?= base_url('data-portal/add'); ?>" class="btn btn-success fa fa-plus-square-o"> Tambah Portal</a>
    <hr>

    <div class="box box-success box-solid">
      <!-- satu box -->
      <div class="box-header with-border">
        <h3 class="box-title">Tabel Data Portal</h3>
      </div>
      <div class="box-body">
        <table id="data-portal" class="table table-bordered table-striped scroll" style="background-color:white;">
            ...
            foreach ($portal as $b) { ?>
              <tr>
                ...
                <td>
                  ...
                  <a href="<?php echo base_url(); ?>data-portal/edit/<?php echo $b->kode_portal ?>" class="btn btn-primary fa fa-edit"> Edit</a>

                  <a href="<?php echo base_url(); ?>portal/delete_portal/<?php echo $b->kode_portal ?>" class="btn btn-danger fa fa-trash-o" onClick="return confirmDelete();"> Hapus</a>
