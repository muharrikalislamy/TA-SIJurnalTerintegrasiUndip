...
<div class="content-wrapper">
    ...
    <div class="box box-primary box-solid"><!-- satu box -->
        <div class="box-header with-border">
          <h3 class="box-title">Penilaian Interdependensi Kriteria</h3>
        ...
        <form class="" action="<?php echo base_url('Interdependensi/update_FU')?>" method="post"> 
          ...
          <div class="row"> <!-- satu baris -->
            ...
            <div class="col-xs-12 col-md-4">
              <div class="form-group">
                ...
                <input class="form-control" name="inputdependensi" placeholder="Nilai Interdependensi" type="number" step="any" required/>
      ...
      <div class="box box-warning box-solid"> <!-- satu box -->
        <div class="box-header with-border">
          <h3 class="box-title">Matriks Interdependensi Antar Kriteria</h3>
      ...
      <table class="table table-bordered table-striped scroll" style="background-color:white;">
        ...
        <tr>
          <th>Total Nilai</th>
          <?php foreach ($kriteria as $key => $krit) {?>
              <th> <?= $krit->jumlah_dependence_kriteria ?> </th>
          <?php }?>
        </tr>
        <!-- total nilai -->
      </table>
      ...
      <div class="box box-warning box-solid"> <!-- satu box -->
        <div class="box-header with-border">
          <h3 class="box-title">Matriks Normalisasi Interdependensi Kriteria</h3>
      ...
      <table class="table table-bordered table-striped scroll" style="background-color:white;">
        ...
        <?php 
          ...
          <tr>
              ...
              <?php } ?>
              <td style="font-weight: bold;"> <?= $krit->bobot_kriteria ?></td> <!-- krit vertikal -->
          <?php } ?>
          </tr>
        <!-- /krit bawah -->
      </table>
      ...
      <div class="box box-warning box-solid"> <!-- satu box -->
        <div class="box-header with-border">
          <h3 class="box-title">Matriks Bobot Interdependensi Kriteria</h3>
      ...
      <table class="table table-bordered table-striped scroll" style="background-color:white;">
        ...
        <?php 
          ...
          <tr>
              ...
              <?php 
                foreach ($kriteria as $key => $value) {?> <!-- foreach nilai matriks --> 
                <td><?= $bode["$krit->kode_kriteria"]["$value->kode_kriteria"]?></td> <!-- nilai matriks -->
              <?php } ?>
          <?php } ?>
          </tr>
        <!-- /krit bawah -->
      ...
      <div class="box box-success box-solid"> <!-- satu box -->
        ...
        <div class="box-body">  
        <table id="bobot-dengan" class="table table-bordered table-striped scroll" style="background-color:white;">
        <thead>
        <tr>
          <th>No</th>
          <th>Kode Kriteria</th>
