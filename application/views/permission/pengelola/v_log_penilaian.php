...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box box-success box-solid">
      ...
      <div class="box-body">
        <table id="log-penilaian-e" class="table table-bordered table-striped scroll" style="background-color:white;">
          <thead>
            <tr>
              <th>No</th>
              <th>Username</th>
          ...
          <tbody>
            ...
            foreach ($logpenilaian as $a) { ?>
              ...
              <tr>
                ...
                <td>
                  <font size="4px">
                    <div class="label label-default"> <?php echo $a->nama ?> </div>
                  </font>
                </td>
